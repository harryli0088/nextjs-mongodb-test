        ...
        if (email) {
          ...
          const $push:{history: ListingHistoryType} = {
            history: {
              ...
              description: "received" //TODO use variable field
            }
          }

          const $set:{status: ListingStatusType} = {
            status: "received", //TODO use variable field
          }
          ...
          const result = await db.collection("listings").updateOne(
            {
              ...
              buyerId: email, //the user bought this listing
              status: "shipped", //TODO make a config variable or something
            },
            {$push, $set},
